...
<div class="container text-center mt-1 py-5">
    <h2 class="text-black font-weight-bold">Register</h2>
    <br>
    <h3>Successfully created account, please <a href="login.php" style="color:red;text-decoration:none;">log in</a></h3>
