...
<section class="my-1 py-2">
  ...
  <button type="submit" style="text-align:center;" name="send_ticket" class="checkout-btn">Send E-Ticket</button>
</form>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p><strong>Order Cost:</strong> <?php echo $order['Order_Cost']; ?></p>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <?php foreach($orderItems as $item) { ?>
          <div class="ticket">
            ...
            <div class="ticket-right" style="margin-top:20px;">
