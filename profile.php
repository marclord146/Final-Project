...
<section id="featured" class="my-3 py-5">
 <div class="container text-center mt-1 py-5">
    <h2 class="text-black font-weight-bold">Profile</h3>
    <br>
    <br>
  ...
  <div class="text-black container">
    <?php $q=mysqli_query($conn,"SELECT * FROM user where Name = '$_SESSION[Name]';");?>
    <?php $row=mysqli_fetch_assoc($q);?>
    <p class="profile">Name:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['Name'];?></p>
    <p class="profile">Email:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['Email'];?></p>
    <p class="profile">Contact:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['Phone_No'];?></p>
    <p class="profile">Address:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['Address'];?></p>
    <a type="submit" class="edit-btn" name="edit" href="editprofile.php?uid=<?php echo $row['userId'];?>">Edit</a>
