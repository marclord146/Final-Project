...
session_id();
session_start();
if(!isset($_SESSION["cart"])|| empty($_SESSION["cart"])){  //If cart is not set or cart is empty then the user will not see this page
...
<section class="my-5 py-5 checkout">
  ...
  <div class="mx-auto container">
    <form id="checkout-form" action="order.php" method="POST">
        ...
        <div class="input-group">
          <h3 style="font-size:40px;">Total: $<?php echo number_format($_SESSION['total'],2);?></h3>
