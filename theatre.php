...
<head>
    ...
    <title>Theatrical Performances</title>
</head>
...
<section id="featured" class="my-5 py-5">
  <div class="container text-center mt-1 py-5">
    <h2 class="text-black font-weight-bold">Theatrical Performances</h3>
    <br>
    <br>

  </div>
  <div class="row mx-auto container-fluid">
    <?php include('getplay.php');?><!--include content from 'getplay.php'-->

    <?php while($row=$play->fetch_assoc()){?><!--While loop to display all Theatrical Performances-->
