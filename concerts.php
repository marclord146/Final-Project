...
<section id="featured" class="my-3 py-5">
  <div class="container text-center mt-1 py-5">
    <h2 class="text-black font-weight-bold">Concerts</h3>
    <br>
    <br>

  </div>
  <div class="row mx-auto container-fluid">
    <?php include('getconcert.php');?><!--include content from 'getconcert.php'-->

    <?php while($row=$concert->fetch_assoc()){?><!--While loop to display all concerts-->
    <div class="product text-center col-lg-3 col-md-4 col-sm-12">
      <img class="img-fluid mb-4" src="media/<?php echo $row['Image'];?>"/>
